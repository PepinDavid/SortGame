export class Poubelle {
    ...
    dessinerPoubelle(context, xView, yView) {
        context.drawImage(
            this.image,// source de l'image
            0,
            0,// a partir de quelles coords (x,y) dans l'image source on duplique
            this.largeur,
            this.hauteur,// jusqu'a quelles coords (x,y) dans l'image source on duplique
